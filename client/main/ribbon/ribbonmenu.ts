...
class RibbonMenu extends HTMLElement implements RibbonItem {
    ...
    _createMenuItem(item, level:number) {
        ...
        let description = h('div', { class: 'description' },
            h('div', { id: labelId1 }, item.title));
        if (item.subtitle)
            description.append(h('div', { id: labelId2, class: 'jmv-ribbon-menu-item-sub' }, item.subtitle));
    ...
    _createModuleItem(item, level:number) {
        ...
        let description = h('div', { class: 'description' },
            h('div', { id: titleId }, item.title));
        if (item.subtitle)
            description.append(h('div', { id: subTitleId, class: 'jmv-ribbon-menu-item-sub' }, item.subtitle));
    ...
    _createMenuGroup(group, level:number) {
        ...
        let groupElement = h('div', { class: 'jmv-ribbon-menu-group',  role: 'group', 'aria-labelledby': labelId }, 
                                h('label', { class: 'jmv-ribbon-menu-heading', id: labelId }, group.title)
                            );
    ...
    _refresh() {
        ...
        let labelElement = h('div', { class: 'jmv-ribbon-button-label', id: this.labelId}, this.title);
