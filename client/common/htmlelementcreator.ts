...
export const richLinksOptions: RichOptions = {
    tags: [...s6eWhitelist, 'a'],
    attributes: {
        a: ['href', 'title'],
    },
...
export const richTableOptions: RichOptions = {
    tags: ['em', 'i', 'sub', 'sup'],
};
 ...
 */
export function rich(input: string, options: RichOptions = {}): DocumentFragment {
    let template = document.createElement('template');
    let fragment = document.createDocumentFragment();
    let allowedTags = new Set(options.tags ?? s6eWhitelist);
