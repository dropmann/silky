...
import {createSelectableLayoutGrid} from './selectablelayoutgrid';
...
export class LayoutSupplierView extends ControlContainer {
    constructor(params) {
        super(params);
    ...
    onContainerRendering(context) {
        ...
        this.supplierGrid = createSelectableLayoutGrid(this.params, false);
        if (label !== null)
