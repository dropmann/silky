...
export class LabelControl extends TitledGridControl<LabelControlProperties> {
    ...
    constructor(params: LabelControlProperties, parent) {
        ...
        this._subel = h('div', { id: this.labelId, role: 'heading', 'aria-level': '3', class: `silky-control-label silky-control-margin-${ this.getPropertyValue("margin") } ${ classes }`, style: 'white-space: nowrap;' }, h('span', {}, groupText));
