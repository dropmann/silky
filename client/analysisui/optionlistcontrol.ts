    ...
    initialize() {
        ...
        if (Array.isArray(columns)) {
            ...
            for (let i = 0; i < columns.length; i++) {
                ...
                let row = 0;
                if (this.showHeaders) {
                    let hCell = this.el.addCell(i, row, h('div', { style: 'white-space: nowrap;', class: 'silky-option-list-header', 'data-index': String(columnInfo.index) }, this.translate(columnInfo.label)));
