...
export function OptionControlBase<TBase extends Constructor<ControlBase>>(Base: TBase) {
    ...
    return class extends Base {
        ...
        onOptionValueChanging(key, data) {
            ...
            this.trigger('optionValueChanging', datas );
            return !datas.cancel;
        }

        onOptionValueChanged(key, data) {
            let datas ={ key, data } 
            this.trigger('optionValueChanged', datas );
        }
        ...
        onOptionValueInserted(key, data) {
            let datas = { key, data };
            this.trigger('optionValueInserted', datas );
        }

        onOptionValueInserting(key, data) {
            let datas ={ key, data, cancel: false } 
            this.trigger('optionValueInserting', datas );
            return !datas.cancel;
        }
        ...
        onOptionValueRemoving(key, data) {
            let datas ={ key, data, cancel: false } 
            this.trigger('optionValueRemoving', datas );
            return !datas.cancel;
        }

        onOptionValueRemoved(key, data) {
            let datas ={ key, data } 
            this.trigger('optionValueRemoved', datas );
        }
