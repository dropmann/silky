...
export class ControlContainer extends LayoutGridClasse(TitledGridControl) {
    constructor(params) {
        super(params);
...
export default { container: ControlContainer, renderContainerItem: deepRenderToGrid };
